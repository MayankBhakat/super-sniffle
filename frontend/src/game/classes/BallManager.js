...
export class BallManager {
    ...
    //This constructor to add a new ball
    addBall(startX) {
    ...
    //Renders the obstacles from the obstacle array of objects (obstacles)
    drawObstacles() {
        this.ctx.fillStyle = 'white';
        this.obstacles.forEach((obstacle) => {
            //start to draw a figure
            this.ctx.beginPath();
    ...
    //Get the color for different sinks
    getColor(index) {
    ...
    //This runs at 60fps
    //U have to repaint the entire canvas from the create the obstacles and sink to ball movements
    ...
    //Stops the updtae loop and esentially stops the animation of the frame
    stop() {
        if (this.requestId) {
